...
MIN_FRAME_HISTORY = 15  # minimum number of frames an agents must have in the past to be picked
MIN_FRAME_FUTURE = 25  # minimum number of frames an agents must have in the future to be picked
